...
class Test_开机(unittest.TestCase):
    ...
    def test_开机(self):    #判断素材 materid
        ...
        print(t_today)
        for i in range(0,1):  #取出      self.nrows
            ...
            # print(ress['share_data']['app-request']['adpid'])
