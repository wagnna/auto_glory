...
class Test_首页新闻(unittest.TestCase):
    ...
    def __init__(self,*args,**kwargs):
        ...
        self.name = r"/Users/wangna/Downloads/API_NEWTest/datas/case2.xlsx"
        self.Sheet_name = "首页帖子"
        # self.real_path = os.path.join(path_data, self.name)
        self.data = load_workbook(r"/Users/wangna/Downloads/API_NEWTest/datas/case2.xlsx")
    ...
    def test_adidtieziself(self):    #判断素材 materid
        # file_name = r"/Users/wangna/Downloads/API_NEWTest/datas/case2.xlsx"  #要变成相对路径
        one_excel = HandleExcel(file_name,"首页新闻")
        ...
        print(t_today)
        for i in range(0,40):  #取出      self.nrows
            ...
            if ress['ad_code'] ==1 and ress["show_type"] !=0:  # m没有dsp怎么写
                ...
                if ress['ad']['dsp']:
                   ...
                   print(ress['share_data']['placement-info']['name']+"不是品牌广告，返回adcode值是："+str(ad_code))
